...
![volumio-ssh-enable](/img/volumio-ssh-enable.png)

SSH 클라이언트(ex.PuTTY)로 접속한다. 기본 계정과 비밀번호는 volumio 이다.  
![volumio-ssh-login](/img/volumio-ssh-login.png)
...
![volumio-tidal-devices](/img/volumio-tidal-devices.png)
...
![tidal-app-master](/img/tidal-app-master.png)
![tidal-app-connect](/img/tidal-app-connect.png)
